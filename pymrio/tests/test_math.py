...
def td_small_MRIO():
    ...
    class IO_Data():
        ...
        A = pd.DataFrame(
                data = [
                    [0.19607843137254902,0.3333333333333333,0.017241379310344827,0.12,0.09615384615384616,0.1794871794871795],
                    [0.0,0.13333333333333333,0.0,0.0,0.09615384615384616,0.07692307692307693],
                    [0.19607843137254902,0.2,0.3448275862068966,0.08,0.038461538461538464,0.0],
                    [0.09803921568627451,0.0,0.0,0.02,0.19230769230769232,0.23076923076923075],
                    [0.0,0.6666666666666666,0.017241379310344827,0.0,0.38461538461538464,0.02564102564102564],
                    [0.09803921568627451,0.0,0.0,0.02,0.19230769230769232,0.2564102564102564],
                    ],
               index = _Z_multiindex,
               columns = _Z_multiindex,
               )
        ...
        L = pd.DataFrame(
                data = [
                    [1.3387146304736708,0.9689762471208287,0.05036622549592462,0.17820960407435948,0.5752019383714646,0.4985179148178926],
                    [0.02200779585580331,1.3716472861392823,0.0076800357678581885,0.006557415453762468,0.2698335633228079,0.15854643902810828],
                    [0.43290422861412026,0.8627066565439678,1.5492942759220427,0.18491657196329184,0.44027825642348534,0.26630955082840885],
                    [0.18799498787612925,0.5244084722329316,0.020254008037620782,1.0542007368783255,0.5816573175534603,0.44685014763069275],
                    [0.04400982046095892,1.5325472495862535,0.05259311578831879,0.014602513642445088,1.9545285794951548,0.2410917825607805],
                    [0.19294222439918532,0.5382086951864299,0.020787008249137116,0.05562707205933412,0.596964089068025,1.4849251515157111],
                    ],
               index = _Z_multiindex,
               columns = _Z_multiindex,
               )
        ...
        S = pd.DataFrame(
                data = [
                    [0.39215686274509803,0.06666666666666667,0.7241379310344828,0.08,0.38461538461538464,0.1282051282051282],
                    [0.09803921568627451,0.26666666666666666,0.1896551724137931,0.16,0.038461538461538464,0.2564102564102564],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
        ...
        M = pd.DataFrame(
                data = [
                    [0.896638324101429,1.7965474933011258,1.1666796580507097,0.3013124703668342,1.4371886818255364,0.7177624711634629],
                    [0.3004620527704837,0.9052387706892087,0.311411003349379,0.23778766312079253,0.5331560745059157,0.6031791628984159],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
        ...
        D_fp = pd.DataFrame(
                data = [
                    [14.059498889254174,18.863255551508175,17.32012296814962,8.71616437964097,18.863255551508175,14.17770265993889],
                    [5.395407054390734,7.594657671782178,5.857880532237175,5.657139420727301,7.594657671782178,7.900257649080434],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
        ...
        D_terr = pd.DataFrame(
                data = [
                    [20.000000000000004,1.0,42.00000000000001,4.0,20.0,5.0],
                    [5.000000000000001,4.0,11.0,8.0,1.9999999999999998,10.0],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
        ...
        D_imp = pd.DataFrame(
                data = [
                    [1.2792573306446737,10.499069649181388,1.2752266807875912,6.604374747509535,8.364185902326788,10.842115601865368],
                    [2.054905005956757,3.9151998960771452,1.522271392125981,1.743464577633809,3.6794577757050337,3.221508682410955],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
        ...
        D_exp = pd.DataFrame(
                data = [
                    [8.251832343364468,0.5304113433404783,17.02843256499675,1.3307504334524414,9.797226856351275,1.9255763708099365],
                    [2.062958085841117,2.1216453733619134,4.459827576546767,2.6615008669048827,0.9797226856351275,3.851152741619873],
                    ],
                 index = ['ext_type_1', 'ext_type_2'],                
                 columns = _Z_multiindex,
                )
